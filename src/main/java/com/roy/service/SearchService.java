...
public class SearchService{
    ...
    public List<Question> searchQuestion (String keyword,int offset,int count,String hiPre,String hiPos) throws Exception{
        List<Question> questionList = new ArrayList<>();
        SolrQuery query = new SolrQuery(keyword);
        query.setRows(count);
        query.setStart(offset);
        query.setHighlight(true);
        query.setHighlightSimplePre(hiPre);
        query.setHighlightSimplePost(hiPos);
        query.set("df","all_text");
